...
import com.customer.service.PurchaseInvoiceItemsService;
 ...
 * The PurchaseInvoiceItemsServiceMockitoTest class uses Mockito to mock dependencies.
...
class PurchaseInvoiceItemsServiceMockitoTest {

    @Mock
    PurchaseInvoiceItemsRepository purchaseInvoiceItemsRep;

    @InjectMocks
    PurchaseInvoiceItemsService purchaseInvoiceItemsSer;

    List<PurchaseInvoiceItems> purchaseInvoiceItems = new ArrayList<>();
    ...
    public void test_getAllPurchaseInvoiceItems() {
        ...
        PurchaseInvoiceItems purchaseInvoiceItem1 = new PurchaseInvoiceItems(1, 30,300.0, s1, si1, purchaseInvoice1);
        PurchaseInvoiceItems purchaseInvoiceItem2 = new PurchaseInvoiceItems(2, 40,400.0, s2, si2, purchaseInvoice2);
    ...
    public void test_getPurchaseInvoiceItemsById() {
        ...
        assertEquals(id, purchaseInvoiceItemsSer.getPurchaseInvoiceItemsById(id).getPurchaseInvoiceItemsId());
    }
    ...
    public void test_createPurchaseInvoiceItems() {
        ...
        assertEquals(purchaseInvoiceItem1, purchaseInvoiceItemsSer.createPurchaseInvoiceItems(purchaseInvoiceItem1));
    }
    ...
    public void test_updatePurchaseInvoiceItems() {
        ...
        assertEquals(purchaseInvoiceItem1, purchaseInvoiceItemsSer.updatePurchaseInvoiceItems(purchaseInvoiceItem1));
    }
    ...
    public void test_deletePurchaseInvoiceItemsById() {
        ...
        purchaseInvoiceItemsSer.deletePurchaseInvoiceItemsById(purchaseInvoiceItem2.getPurchaseInvoiceItemsId());
