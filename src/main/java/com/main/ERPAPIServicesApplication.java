 ...
 * Usage:
 * The ERPAPIServicesApplication class acts as the starting point of the entire application.
...
public class ERPAPIServicesApplication {
	...
	public static void main(String[] args) {
		SpringApplication.run(ERPAPIServicesApplication.class, args);
	}
